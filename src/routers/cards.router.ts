...
import { createCard, deleteCard, getManyCards, getOneCard, updateCard } from '../database/cards-repository';
...
cardsRouter.get(
  '/:id',
  async (request: Request<IdParams, Card | string, {}>, response: Response<Card | string>) => {
